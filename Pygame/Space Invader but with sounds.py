...
score_value = 0
font = pygame.font.Font('times.ttf', 64)
textX = 10
textY = 10
over_font = pygame.font.Font('times.ttf', 64)
...
def isCollision(enemy_x, enemy_y, bullet_x,
                bullet_y):
...
pygame.mixer.init()
bullet = pygame.mixer.Sound("laser-381976 (1).mp3")
